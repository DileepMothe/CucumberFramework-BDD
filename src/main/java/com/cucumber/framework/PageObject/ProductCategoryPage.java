...
public class ProductCategoryPage {
	...
	public void selectColor(String data){
		new com.cucumber.framework.helper.javascript.JavaScriptHelper(driver).scrollIntoView(driver.findElement(By.xpath("//a[contains(text(),'"+data+"')]/parent::*/preceding-sibling::input[1]")));
